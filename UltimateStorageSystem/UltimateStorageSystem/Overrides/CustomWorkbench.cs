        ...
        public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
        {
            ...
            if (!globalChestMutex.IsLocked())
            {
                ...
                globalChestMutex.RequestLock(() =>
                {
                    ...
                    Game1.activeClickableMenu = new CraftingPage((int)centeringOnScreen.X, (int)centeringOnScreen.Y, 800 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2, false, true, inventories);
